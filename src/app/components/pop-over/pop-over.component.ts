  ...
  async presentActionSheet() {
    const actionSheet = await this.actionSheetController.create({
      ...
      buttons: [{
        ...
        icon: 'call',
        handler: () => {
          console.log('+888888888888 clicked');
          this.callNumber.callNumber('+888888888888', true)
        ...
        icon: 'at',
        handler: () => {
          console.log('abc@gmail.com clicked');
          this.socialSharing.canShareViaEmail().then(async () => {
            // Success
            this.socialSharing.shareViaEmail(this.body, this.subject, ['abc@gmail.com']).then(async (res) => {
              // Success
